...
<ul>
	<li>127.0.0.1 : 자기 자신을 가르키는 IP주소</li>
...
<ul>
	<li>
	<a href="http://localhost:8080/chap01/00_basic/index.jsp">접속하기</a>
	</li>
	<li>8080은 톰켓이 기본적으로 사용하는 포트번호이다.</li>
	<li>
		https://www.naver.com
		프로토콜: https <br>
...
<ul>
	<li>URL에서 IP주소가 입력되어야 하는 자리에 IP주소 대신 다른 영어로된 문자가 들어있다면 
		바로 해당 서버를 찾아가는 것이 아니라 DNS서버에 들러 IP주소를 받은 뒤 찾아가게 된다.
	</li>
	<li>
	우리 IP주소는 DNS서버에 등록되어있지 않기 때문에 아직은 도메인 이름을 사용할 수 없다
	</li>
...
<ul>
	<li>
		24시간 대기하고 잇다가사용자가 접속하면 사용자가 원하는 웹 페이지를 응답(response)해주는 프로그램
	</li>
...
<ul>
	...
	<li>webapp 또는 WebContent <br> 
		...
		- 접속하는 사용자에게 이곳에 등록된 .html, .jsp등을 응답해준다 <br>	
	</li>
</ul>
