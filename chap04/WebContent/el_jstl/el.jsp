...
<body>
	...
	<ol>
		<li>그냥 출력: ${most } (가장 좁은 범위의 어트리뷰트가 선택됨)</li>
		<li>request를 출력: ${requestScope.most }</li>
		<li>session를 출력: ${sessionScope.most }</li>
		<li>application를 출력: ${applicationScope.most }</li>
	</ol>
